...
abstract class BaseActivity: AppCompatActivity() {
    ...
    private var noCompatScaledDensity = resources.displayMetrics.scaledDensity
    private var noCompatDensity = resources.displayMetrics.density

    private var screenOrientation: Boolean = resources.configuration.orientation == Configuration.ORIENTATION_LANDSCAPE
    ...
    protected fun autoSize(){
        ...
        val targetDensity = (screenWidthPixels * 1.0f) / Const.DESIGN_UI_WIDTH_DP
