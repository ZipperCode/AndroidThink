 ...
 * @author zzp
 */
public abstract class BaseDialogFragmentX extends DialogFragment implements
    ...
    public BaseDialogFragmentX(FragmentActivity activity) {
    ...
    public void toast(String stringResName) {
        ...
        ToastHelper.getInstance(requireActivity().getApplication()).toast(stringResName);
    }
