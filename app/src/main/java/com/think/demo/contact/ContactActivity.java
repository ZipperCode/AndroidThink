package com.think.demo.contact;
...
public class ContactActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contct);
    ...
    private void showContacts() {
        ArrayList<MyContacts> contacts = ContactUtils.getAllContacts(ContactActivity.this);
